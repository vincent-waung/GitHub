...
namespace Models.PocoModel
{
    ...
    public partial class POCO_Sys_Permission
    {
        ...
        public Nullable<short> pFormMethod { get; set; }
        public Nullable<short> pOperationType { get; set; }
        ...
        public System.DateTime pOperTime { get; set; }
    }
}
